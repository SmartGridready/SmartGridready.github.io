...
.. list-table:: Component Description
    ...
    *   -   :term:`DSO`-Interface`
        -   Interface to the Distribution System (power-grid) Operator. The interface allows load management by the operator and getting tariff
